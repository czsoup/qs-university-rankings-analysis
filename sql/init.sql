-- ==========================================================================
-- init.sql  :  DROP + CREATE + INSERT en une seule commande
-- Utilise ce fichier pour importer la base sur Railway ou n'importe quel serveur
-- Usage PowerShell : Get-Content "sql\init.sql" -Raw | mysql -u root
-- ==========================================================================

DROP DATABASE IF EXISTS qs_rankings;
CREATE DATABASE qs_rankings CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE qs_rankings;
